...
I mainly used framer motion to animate element on unmount using the `<AnimatePresence>` component. In the future I'd like to animate the board's sheet modal using framer motion instead of janky css animations.
