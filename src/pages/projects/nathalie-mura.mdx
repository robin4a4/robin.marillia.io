...
I did not use typescript as I was not confortable enough with it at the time but it should be easy to port it to typescritp in the future given the small size of the project.
